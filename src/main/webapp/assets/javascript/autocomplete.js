...
function permissionNameAutocomplete() {
    ...
    $('#permissionName').autocomplete({ 
        ...
        select : function(event, ui) {
			...
			enixClever.api.permission.selectPermissionInfo(ui.item.idx, function (res) {
		        _docCreate.permissionTable.setPermissionData(res.data.permissionInfo.accessorList);
		    });
