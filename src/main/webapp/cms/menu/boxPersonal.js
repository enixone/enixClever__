$(document).ready(function () {
   ...
   $('#personalBoxTree').jstree({
		'core' : {
			'data' : {
				"url" : "/enixClever/plugins/jstree/demo/basic/root.json",
...
function fnInit() {
	...
	// 우측 리스트 로드
	$("#mainContentDiv").load(constants.url["deptDocument"], function() {
...
function fnInitTree(nodeList) {
    ...
    treeObj = $("#groupBoxTree").fancytree({
        ...
        activate: function(event, data) {
			...
			fnSelectDocList(currentFolderInfo.folderId);
