$(document).ready(function () {
    ...
    tableOption = {
        ...
        callbackFunctions: {
            ...
            navigatePageCallback : fnSelectFolderDocList,
            rowClickCallback: evtDocListRowClick,
            rowDoubleClickCallback: evtDocListRowDoubleClick,
        }
    };
...
function fnInitTree(nodeList) {
    ...
    treeObj = $("#groupBoxTree").fancytree({
        ...
        lazyLoad: function(event, data) {
            ...
            enixClever.api.folder.selectGroupChildFolderList(_childParam, function (res) {
 ...
 * @param docInfo
 */
function evtDocListRowDoubleClick(docInfo) {
    currentDocInfo = docInfo;

    enixClever.modal.load(
        constants.url.documentView,
        {
