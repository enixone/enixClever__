		...
		/** @lends Fancytree_Hooks# */
		{
			...
			nodeRender: function(ctx, force, deep, collapsed, _recursive) {
				...
				if (children) {
					...
					if (node.ul) {
						// enixClever.alert.info("remove child markup for " + node);
	...
	$.widget(
		...
		/** @lends Fancytree_Widget# */
		{
			...
			_bind: function() {
				...
				//enixClever.alert.info("keydown" + ns + "foc=" + tree.hasFocus() + tree.$container);
	...
	function onDropEvent(event) {
		...
		switch (event.type) {
			case "dragenter":
				...
				// enixClever.alert.info("res:" + JSON.stringify(res))
...
//	        enixClever.alert.info("treeSetFocus" + ctx.tree.$container);
